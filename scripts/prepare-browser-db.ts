...
const databaseUrl = process.env.ASSURAPAY_TEST_DATABASE_URL;
if (!databaseUrl) throw new Error('ASSURAPAY_TEST_DATABASE_URL is required for browser preparation');
