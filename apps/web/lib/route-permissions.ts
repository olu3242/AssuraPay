...
export const ROUTE_PERMISSION_REQUIREMENTS: Readonly<Record<string, RouteAccess>> = {
  ...
  '/api/v1/flows|GET': { access: 'permission', permissionKey: 'executions:read' },
