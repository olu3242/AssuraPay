...
| --- | --- | --- | --- | --- | --- |
| persistence.async-domain-repository-interface | Asynchronous domain repository interface | implemented | implemented | 7/7 | All 7 evidence probes satisfied at HEAD. |
...
| persistence.domain-store-durability | Domain store durability for Engines 06-60 | implemented | implemented | 4/4 | All 4 evidence probes satisfied at HEAD. |
| persistence.domain-store-environment-gate | Domain store durable-environment gate | implemented | implemented | 8/8 | All 8 evidence probes satisfied at HEAD. |
